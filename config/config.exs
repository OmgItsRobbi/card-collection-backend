...
config :card_collection, CardCollectionWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: CardCollectionWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: CardCollection.PubSub,
  live_view: [signing_salt: "Yifr3Le2"]
...
config :arke_server,:mailer_module, CardCollection.Mailer

# The endpoint module define which servers show in the swagger. You can pass a single one or a list
config :arke_server, endpoint_module: CardCollectionWeb.Endpoint
